...
usethis::use_mit_license( "Jan Seifert" )  # You can set another license here
...
golem::use_favicon() # path = "path/to/ico". Can be an online file. https://favicon.io/favicon-converter/
